...
fun main(){
    /*
    var listaConta:ArrayList<ContaBancaria> = ArrayList<ContaBancaria>()
        ...
        when(resposta){
            ...
            3 -> {
                ...
                if(banco.verificaLista(numeroConta) >= 0){
                    ...
                    var contaBancaria = banco.listaConta[numeroConta]

                    banco.remover(contaBancaria)
            ...
            4 -> relatorio.gerarRelatorio(banco)
